...
\hypertarget{sc__flexint_8h_source}{}\label{sc__flexint_8h_source}\index{S:/code/QT\_VHDL\_simulator/code/Qt\_VHDL\_SVG\_proj/systemC/systemc\_modules/sc\_flexint.h@{S:/code/QT\_VHDL\_simulator/code/Qt\_VHDL\_SVG\_proj/systemC/systemc\_modules/sc\_flexint.h}}
...
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keyword}{typedef}\ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_lv<1>}}\ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_a29f87da87e9bb432b08478282c0273ac}{rst\_t}};}
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{keyword}{typedef}\ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_lv<1>}}\ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_aa0511843e65611a5fa3983be760651e0}{ena\_t}};}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00060\ \ \ \ \ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/\ \ \ \ \ \ Ports\ \ \ \ \ \ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00061\ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_in\_clk}}\ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_a1e4fd4a2887ce1f04ed69ad3310d82e3}{clock}}\{\textcolor{stringliteral}{"{}clock"{}}\};\ \ \ \ \textcolor{comment}{//\ Clock\ input}}
\DoxyCodeLine{00062\ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_in<rst\_t>}}\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_ac390cd8a53617fc560f55603d7b32dcb}{reset}}\{\textcolor{stringliteral}{"{}reset"{}}\};\ \ \ \ \textcolor{comment}{//\ Asynchronous\ reset\ input}}
\DoxyCodeLine{00063\ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_in<ena\_t>}}\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_a62d49c19c366a2506a142b2d6bd49305}{enable}}\{\textcolor{stringliteral}{"{}enable"{}}\};\ \ \textcolor{comment}{//\ Synchronous\ enable\ input}}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ \ \ \ \ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/\ Local\ variables\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00066\ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_signal<rst\_t>}}\ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_ac76aa62c3a7f25bbc2c91ffcac0c531f}{rst\_defbind}}\{\textcolor{stringliteral}{"{}IGNORErst"{}}\};\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ To\ bind\ unused\ ports}}
\DoxyCodeLine{00067\ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sc\_signal<ena\_t>}}\ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_a104170f01d9d7d15388f3162368c2230}{ena\_defbind}}\{\textcolor{stringliteral}{"{}IGNOREena"{}}\};\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ To\ bind\ unused\ ports}}
...
\DoxyCodeLine{00074\ \ \ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{class_sysc_t_and}{SyscFlexInt<CLKEDGE,\ FLEXINT>}}\ \mbox{\hyperlink{class_sysc_flex_int_a13b5e047e0736affd47d040d8d1ce905}{SC\_CURRENT\_USER\_MODULE}};}
\DoxyCodeLine{00075\ }
...
\DoxyCodeLine{00077\ \ \ \ \ \{}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_a0601cf9ae3ae92a3488d01ecb33fb94c}{flexintDecode}}((\mbox{\hyperlink{class_sysc_t_and}{uint8\_t}})((\mbox{\hyperlink{class_sysc_t_and}{FLEXINT}}\ \&\ 0x00F0)\ >>\ 4),\ \&\mbox{\hyperlink{class_sysc_flex_int_a3a6875691201096880a125f877defc72}{use\_rst}},\ \&\mbox{\hyperlink{class_sysc_flex_int_a3e943ce206207b6962629ccd69e90e5e}{rst\_level}});}
\DoxyCodeLine{00079\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_flex_int_a0601cf9ae3ae92a3488d01ecb33fb94c}{flexintDecode}}((\mbox{\hyperlink{class_sysc_t_and}{uint8\_t}})(\mbox{\hyperlink{class_sysc_t_and}{FLEXINT}}\ \&\ 0x000F),\ \&\mbox{\hyperlink{class_sysc_flex_int_a0996f532f7f16d38b66dd3fc9c43d710}{use\_ena}},\ \&\mbox{\hyperlink{class_sysc_flex_int_a344867cc899517f82551bbbd3f3b9576}{ena\_level}});}
\DoxyCodeLine{00080\ \ \ \ \ \}}
\DoxyCodeLine{00081\ }
...
\DoxyCodeLine{00083\ \ \ \ \ \{}
\DoxyCodeLine{00084\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\mbox{\hyperlink{class_sysc_t_and}{CLKEDGE}})}
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sensitive}}\ <<\ \mbox{\hyperlink{class_sysc_flex_int_a1e4fd4a2887ce1f04ed69ad3310d82e3}{clock}}.pos();}
\DoxyCodeLine{00087\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{00089\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00090\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sensitive}}\ <<\ \mbox{\hyperlink{class_sysc_flex_int_a1e4fd4a2887ce1f04ed69ad3310d82e3}{clock}}.neg();}
\DoxyCodeLine{00091\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00092\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{class_sysc_flex_int_a3a6875691201096880a125f877defc72}{use\_rst}})}
\DoxyCodeLine{00093\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_sysc_t_and}{sensitive}}\ <<\ \mbox{\hyperlink{class_sysc_flex_int_ac390cd8a53617fc560f55603d7b32dcb}{reset}};}
\DoxyCodeLine{00095\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00096\ \ \ \ \ \}}
\DoxyCodeLine{00097\ }
...
\DoxyCodeLine{00117\ \ \ \ \ \}}
\DoxyCodeLine{00118\ }
\DoxyCodeLine{00119\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_sysc_flex_int_a0601cf9ae3ae92a3488d01ecb33fb94c}{flexintDecode}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_sysc_t_and}{uint8\_t}}\ \mbox{\hyperlink{class_sysc_t_and}{f}},\ \textcolor{keywordtype}{bool}\ *\mbox{\hyperlink{class_sysc_t_and}{use}},\ \textcolor{keywordtype}{bool}\ *level)}
\DoxyCodeLine{00120\ \ \ \ \ \{}
\DoxyCodeLine{00121\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{switch}\ (\mbox{\hyperlink{class_sysc_t_and}{f}})}
\DoxyCodeLine{00122\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00123\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ 0x01:}
\DoxyCodeLine{00124\ \ \ \ \ \ \ \ \ \ \ \ \ *\mbox{\hyperlink{class_sysc_t_and}{use}}\ =\ \textcolor{keyword}{true};}
...
\DoxyCodeLine{00128\ \ \ \ \ \ \ \ \ \ \ \ \ *\mbox{\hyperlink{class_sysc_t_and}{use}}\ =\ \textcolor{keyword}{true};}
...
\DoxyCodeLine{00132\ \ \ \ \ \ \ \ \ \ \ \ \ *\mbox{\hyperlink{class_sysc_t_and}{use}}\ =\ \textcolor{keyword}{false};}
...
\DoxyCodeLine{00144\ \ \ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structis__boolean}{is\_boolean}}<\mbox{\hyperlink{class_sysc_t_and}{bool}}>:\ \textcolor{keyword}{public}\ std::true\_type\ \{\ \};}
\DoxyCodeLine{00145\ }
