...
void SvgParser::parse_svg(QString svg_file)
{
    // Open the SVG file
    QFile file(svg_file);
    QDomDocument doc;
...
void SvgParser::parse_by_group(const QDomNode &node, s_tree_node &parentNode, int level)
...
void SvgParser::generate_tree(const s_tree_node &node, const QString &prefix)
{
...
void SvgParser::parse_components(s_tree_node &node)
{
...
QString SvgParser::attr_name_for_str(QString attr)
{
    return custom_attribute + ":" + attr;
}

QString SvgParser::attr(e_types type)
{
    switch (type)
    {
    case e_types::label:
...
void SvgParser::get_group_header(const QDomElement &element, s_tree_node_info &infos)
{
...
void SvgParser::parse_element(s_tree_node &node)
{
...
void SvgParser::parse_simulation_IOs(const QDomElement svg_group_xml, s_sim_I_Os &parsed_IOs)
{
...
int SvgParser::get_list_of_outputs_name_and_width(QString outputs_string, QList<s_element_io> &outputs_list)
{
...
int SvgParser::get_list_of_inputs_name_and_width(QString inputs_string, QList<s_element_io> &inputs_list)
{
...
bool SvgParser::check_and_get_attr(const QDomElement &xml, QString &str_to_get, QString attr_name)
{
...
void SvgParser::add_error_message(s_parse_error &error, const QString &errorMessage)
{
    error.is_parse_error = true;
    error.error_messages.push_back(errorMessage);
}

void SvgParser::parse_simulation_wires(const QDomElement svg_group_xml, s_sim_wires &parsed_wires)
{
...
void SvgParser::list_matching_attr_with_value(const QDomElement elem_to_look_into, const QString attr_name, const QString attr_value, QList<QDomElement> &found_elements)
{
...
int SvgParser::list_matching_attr(const QDomElement elem_to_look_into, const QString attr_name, QList<QDomElement> &found_elements)
{
    // Find attributes with a fixed value
    QDomElement child = elem_to_look_into.firstChildElement();
    while (!child.isNull())
