 ...
 * @details A generic SystemC module that implements an AND gate with N inputs and 1 output.
 * The gate is combinational, i.e., the output is updated whenever any of the inputs changes.
 */
template <unsigned int N = 2, unsigned int W = 1>
...
/**
 * @brief The SyscNand class
 * @details A generic SystemC module that implements a NAND gate with N inputs and 1 output.
 * The gate is combinational, i.e., the output is updated whenever any of the inputs changes.
 */
template <unsigned int N = 2, unsigned int W = 1>
...
/**
 * @brief The SyscOr class
 * @details A generic SystemC module that implements an OR gate with N inputs and 1 output.
 * The gate is combinational, i.e., the output is updated whenever any of the inputs changes.
 */
template <unsigned int N = 2, unsigned int W = 1>
...
/**
 * @brief The SyscNor class
 * @details A generic SystemC module that implements a NOR gate with N inputs and 1 output.
 * The gate is combinational, i.e., the output is updated whenever any of the inputs changes.
 */
template <unsigned int N = 2, unsigned int W = 1>
...
/**
 * @brief The SyscXor class
 * @details A generic SystemC module that implements an XOR gate with N inputs and 1 output.
 * The gate is combinational, i.e., the output is updated whenever any of the inputs changes.
 */
template <unsigned int N = 2, unsigned int W = 1>
...
/**
 * @brief The SyscXnor class
 * @details A generic SystemC module that implements an XNOR gate with N inputs and 1 output.
 * The gate is combinational, i.e., the output is updated whenever any of the inputs changes.
 */
template <unsigned int N = 2, unsigned int W = 1>
